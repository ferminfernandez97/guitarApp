...
export class guitarsService {
  ...
  private guitars:Guitar[] = [
   {
     name: "FENDER PLAYER STRATOCASTER® PLUS TOP",
     ...
     strings: "6 Strings",
     brand:"assets/img/fenderlogo.png"
   },
   {
     name: "FENDER PLAYER TELECASTER® HH",
   ...
   {
     name: "FENDER ERIC JOHNSON SIGNATURE STRATOCASTER® THINLINE",
   ...
   },
   {
     ...
     strings: "6 Strings",
     brand:"assets/img/schecterlogo.png"
   },
   {
     name: "EPHIPHONE DR-100®",
     ...
     strings: "6 Strings",
     brand:"assets/img/epiphonelogo.png"
   },
   {
     name: "EPHIPHONE Masterbilt Century Olympic",
  ...
  searchGuitars( termino:string ){
    let guitarsArr:Guitar[] = [];
    termino = termino.toLowerCase();

    for( let guitar of this.guitars){
      let nombre = guitar.name.toLowerCase();
      if(nombre.indexOf( termino ) >= 0){
        guitarsArr.push( guitar )
      }
    }
